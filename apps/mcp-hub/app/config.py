...
class Settings(BaseSettings):
    ...
    wan_i2v_model: str = Field(default="happyhorse-1.0-i2v", alias="MCP_WAN_I2V_MODEL")
    wan_r2v_model: str = Field(default="wan2.7-r2v", alias="MCP_WAN_R2V_MODEL")
    wan_video_edit_model: str = Field(default="wan2.7-videoedit", alias="MCP_WAN_VIDEO_EDIT_MODEL")
